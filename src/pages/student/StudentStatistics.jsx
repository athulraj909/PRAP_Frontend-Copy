...
function StudentStatistics() {
    ...
    useEffect(() => {
        ...
        loadAssessmentHistory(studentData.mobile);
    }, [navigate]);

    const loadAssessmentHistory = async (mobile) => {
        try {
            setLoading(true);
            const history = await assessmentHistoryService.getAssessmentHistory(mobile);
        ...
        <div className="student-statistics-page">
            <div className="page-container">
                <div className="page-header">
                    ...
                    <h1>My Performance Statistics</h1>
                    <div></div>
                </div>
                ...
                {assessmentHistory.length === 0 ? (
                    <Card>
                        <div className="empty-state">
                            <p>No assessment data available yet. Take an assessment to see your statistics.</p>
